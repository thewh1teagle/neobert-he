...
from xformers.ops import SwiGLU  # noqa: E402
...
from .rotary import precompute_freqs_cis, apply_rotary_emb  # noqa: E402
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, config: NeoBERTConfig):
        ...
        self.ffn = PureSwiGLU(config.hidden_size, intermediate_size, config.hidden_size, bias=False) if _ONNX_EXPORT else SwiGLU(config.hidden_size, intermediate_size, config.hidden_size, bias=False)
